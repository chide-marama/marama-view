...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item A continuous integration system must be used to ensure that the program can properly build, so that multiple people can work on it and check that everyone's code is still running properly.
