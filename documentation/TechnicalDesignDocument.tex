...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item The program should let users add maramaficatio objects to a world.
        ...
        \item A game program should exist where the user can use the editor with a predefined Marama and limited maramafication options.
    \end{itemize}
