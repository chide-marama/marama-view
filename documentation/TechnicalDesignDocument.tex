...
\begin{document}
    ...
    These m-blocks are already loaded into the assetmanger in the background, so that makes i quite simple to add these.
    ...
    The location where the m-block is placed is worked out in another user story (#2e294).
