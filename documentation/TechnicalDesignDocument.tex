...
It uses the face of the target \code{SelectableInstance} and that of the origin \code{SelectableInstance} to position the new \code{SelectableInstance} in the correct spot.
    ...
    \myparagraph{Communication from the View to the Editor}
    ...
    \myparagraph{Able to load in a 3D object received from the Editor}
    ...
    \myparagraph{Validating if objects can be connected trough Editor communication}
