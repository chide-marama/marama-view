...
\begin{document}
    ...
    Every SelectableInstance has a list of Joints which contain a vector3 which states the location of the faces of the instance that can be interacted with.
