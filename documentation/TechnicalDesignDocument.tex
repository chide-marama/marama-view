...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item The program should be accessible on multiple platforms, mostly focusing on Android and PC.
        \item A continuous integration system should be used to ensure that the program can properly build, even with multiple people working on it.
